"""profile outlets subs ai_pref

Revision ID: 960829e8f7f4
Revises: 0c334c525870
Create Date: 2026-09-09 13:47:07.202606
...
def upgrade() -> None:
    ...
    sa.Column('weather_sensitivity_mode', sa.String(length=20), nullable=False),
    sa.Column('max_critical_discount', sa.Integer(), nullable=False),
    sa.Column('last_offline_sync', sa.DateTime(), nullable=True),
